...
#define	_BOARD_NAME_	"6LoWPAN Clicker"

/* Pin mappings
 *
 * Click connector
 *
 *           AN/RG9  0 |O|       |O| 11 RF3/PWM
 *          RST/RD6  1 |O|       |O| 10 RD0/INT
 *           CS/RE5  2 |O|       |O| 9  RF5/RX
 *          SCK/RD2  3 |O|       |O| 8  RF4/TX
 *         MISO/RD3  4 |O|       |O| 7  RD10/SCL
 *         MOSI/RD4  5 |O|       |O| 6  RD9/SDA
 *            +3.3V    |O|       |O|    +5V
 *              GND    |O|       |O|    GND
 *
 * LEDs and Buttons
